package com.mdiapps.mdi.mymvp.helpers.CustomAdapter;
...
public class NoticeAdapter extends ArrayAdapter<String> {
    ...
    public NoticeAdapter(Activity context, List<String> noticelist_notice_date, List<String> noticelist_notice_title, List<String> noticelist_notice_detail) {
